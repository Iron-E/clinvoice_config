//! `clinvoice_config` provides a definition for the [CLInvoice user config](Config), as well
//! as the ability to [read](Config::read) and [write](Config::write) it from/to disk.
//!
